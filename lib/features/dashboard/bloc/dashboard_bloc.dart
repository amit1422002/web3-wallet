...
class DashboardBloc extends Bloc<DashboardEvent, DashboardState> {
  ...
  FutureOr<void> dashboardInitialFechEvent(
    ...
    try {
      ...
      String privateKey =
          "0x8db654b6907b1ea99f57f8d084f045f4da4c3dc4de87b1a4f707c809584eba51";
      ...
      _contractAddress =
          EthereumAddress.fromHex("0x0CA76371452E7246CA49D42BFfead635e4Ff82Bf");
      ...
      final balanceData = await _web3Client!
        ...
        EthereumAddress.fromHex("0x1608604F7A3382E4ec9306d32d89d16093864bac")
      ]);
    ...
    try {
      final transaction = Transaction.callContract(
          from: EthereumAddress.fromHex(
              "0x1608604F7A3382E4ec9306d32d89d16093864bac"),
          contract: _deployedContract,
          function: _deposit,
          parameters: [
