...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:
          AppBar(title: Center(child: Text("Ethereum Wallet",style:TextStyle(fontSize: 30,fontWeight: FontWeight.bold),)), backgroundColor: AppColors.accent),
                    ...
                    Center(
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Image.asset("assets/images/eth_logo.jpeg",height: 50,width: 50,),
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
Image.asset("assets/images/eth_logo.jpeg",height: 24,width: 24,),
